  ...
  <div class="popup-bg">
    <div class="popup-wizard">
      <div class="popup-wizard-content">
        ...
        <img class="preview-img" src="../../assets/Cards/Popup/Illustrations/done.png" alt="" />

        <h2 class="delete-header">Are you sure?</h2>
        <p class="bold-p info-p">
          You're are about to delete your payment method. Make sure to add a new payment to streamline your next checkout.
        </p>
...
export default {
  data() {
    return {
      deleteId: this.$store.state.wizard.removeCardId,
    }
  },
  created() {
    const self = this
    this.$nuxt.$on('load-card-delete-id', (id) => {
      self.deleteId = id
    })
  },
  mounted() {
  ...
  methods: {
    ...
    async submit() {
      ...
      await callUrlWithJwt(
        ...
        this.$store.state.apiConfiguration.urlRemoveCard,
        'POST',
        {
          id: this.deleteId
        }
