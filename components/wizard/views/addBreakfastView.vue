<template>
  <div class="view">
    <div class="meal-nav">
      ...
      <p class="meal-nav-header center-abs">Add Breakfast ({{ this.$store.state.cart.selectedBreakfast.length }}/2)</p>
    </div>
    <div class="view-content center-hor-margin">
      <p class="meal-nbr-index">Choose 2 items</p>

      <!-- render the breakfast elements there -->
      <div v-for="breakfast in this.$store.state.wizard.breakfastMeals" :key="breakfast.id" class="w-meals-view-card meal-item">
        ...
        <div class="meal-info-wrapper">
          <p class="meal-item-name">{{ breakfast.name }}</p>
          <div class="meal-values">
            <div class="value-pair">
              ...
              <p>{{ breakfast.calories }}g Calories</p>
            </div>
            ...
            <div class="value-pair">
              ...
              <p>{{ breakfast.protein }}g Protein</p>
            </div>
          </div>
        </div>

        <div class="buttons-wrapper">
          <button class="meal-info b-t ms-outlined-button">INFO</button>
          <!-- include the stepper component -->
          <stepper
            v-bind:dish="breakfast"
            v-bind:selected="0"
          />
        </div>
      </div>
...
<script>
import stepper from './../components/breakfastStepper.vue'
import { getBreakfastItemsTotalPrice } from './../../mealFunctions.js'
...
export default {
  ...
  mounted() {
    $nuxt.$emit('show-and-count-points', true, getBreakfastItemsTotalPrice(this.$store))
  },
}
</script>
