      ...
      <div class="w-meals-view-card meal-item">
        ...
        <div class="meal-info-wrapper">
          <p class="meal-item-name">
            <span class="thin-text">Order name</span>
          </p>
        ...
        <div class="stepper-price">
          <button class="b-t ms-outlined-button">RECEIPT</button>
          <button class="meal-button select-btn">REPEAT</button>
        </div>
      </div>
    </div>
    <!-- end of past orders -->
...
<div class="w-meals-view-card meal-item">
        ...
        <div class="meal-info-wrapper">
          <p class="meal-item-name">
            <span class="thin-text">Upcoming order</span>
          </p>
          <div class="meal-values">
            <div class="value-pair">
              <svg
...
export default {
  ...
  methods: {
    toggleSelect() {
      if (this.orderViewActive === 1) this.orderViewActive = 2
      else this.orderViewActive = 1
    },
  },
  mounted() {
